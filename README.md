...
3. After installation, configure options as described above.

**To submit your extension:**
Package the extension using the provided PowerShell script (`scripts/package.ps1`).
.\scripts\package.ps1
...
```powershell
.\scripts\dev.ps1
4. The field is filled and change/input events are dispatched.
